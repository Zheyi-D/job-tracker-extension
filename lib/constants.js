...
export const STORAGE_KEYS = {
  ...
  updateInfo: 'jt_update_info',       // storage.local：最新版本检测结果
  updateDismissed: 'jt_update_dismissed' // storage.session：用户已忽略的版本号
};

export const UPDATE_REPO_API = 'https://api.github.com/repos/Zheyi-D/job-tracker-extension/releases/latest';
export const UPDATE_CHECK_INTERVAL_MIN = 360; // 每 6 小时检查一次
